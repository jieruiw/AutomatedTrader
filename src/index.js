...
var TradeExecutor_1 = require("./services/TradeExecutor");
...
var tradeExecutor = new TradeExecutor_1.default(config, initialCash);
...
var scheduler = new Scheduler_1.default(config);
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                // Start the Scheduler
                return [4 /*yield*/, scheduler.start(stocks)];
                case 1:
                    // Start the Scheduler
                    _a.sent();
                    // Manually trigger the stock check
                    return [4 /*yield*/, scheduler.manualCheck()];
                case 2:
                    // Manually trigger the stock check
                    _a.sent();

...
async function initialize() {
    ...
    if (fs.existsSync(filePath)) {
        ...
        let stocks = ['TSM', 'ARM', 'TSLA', 'AAPL', 'NVDA', 'MGM', 'GPS', 'AMZN', 'RIVN', 'F', 'MSFT', 'META',
            ...
            'NWPX', 'OSPN', 'AGS', 'SPXC', 'VMI', 'AXTA', 'GRMN', 'NGD', 'CVLT', 'VTMX', 'MS', 'POWL',  'TMHC', 'WING', 'ZBRA',
            'AEM', 'MBIN', 'MTX', 'AMKR', 'KALU', 'SKX', 'UMBF', 'CSL', 'EXPO', 'NTNX', 'OSK', 'PIPR', 'PUBM', 'SKYW',
            'TPH', 'SPOT', 'WAB', 'ERO', 'MEDP', 'PHM', 'AZZ', 'ASIX', 'LPX', 'AU', 'BMI', 'GFI',
            ...
            'DBX', 'AOSL', 'IDN', 'KBCSY', 'BEKE', 'KD', 'IAG', 'SIG', 'SCCO', 'SRDX', 'GOOS', 'NEWT', 'PETQ', 'BWEN',
            'GS', 'IPW', 'HL', 'ODD', 'PED', 'ACIC', 'EMBC', 'SRTS', 'SNCR',  'ANET', 'BLBD', 'HBI', 'HMY', 'ITRI', 'SLVM',
            'VITL', 'APP', 'ASM', 'DDOG', 'EPC', 'GLDD', 'HY', 'OGN', 'PMT', 'SN', 'TRTX', 'TPC', 'ARKO', 'SIMO', 'SFM'];
